...
def decode_execution_providers(execution_providers: List[str]) -> List[str]:
    ...
    print("Encoded Providers:", encoded_providers)

    matched_providers = [
        provider for provider, encoded_provider in zip(available_providers, encoded_providers)
        if any(execution_provider in encoded_provider for execution_provider in execution_providers)
    ]

    print("Matched Providers:", matched_providers)
